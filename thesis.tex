...
\newcommand{\RV}{\ensuremath{\mu_{ggH,ttH}}\xspace}
\newcommand{\RF}{\ensuremath{\mu_{VBF,VH}}\xspace}
...
\hypersetup{%
pdftitle = {Properties of the Higgs-like state around 125 GeV in its decay to two photons at the CMS experiment},
...
\title{Properties of the Higgs-like state around 125 GeV in its decay to two photons at the CMS experiment}
...
\begin{mainmatter}
  ...
  \input{cms_experiment/cms_experiment.tex}
  \input{analysis_comps/analysis_comps.tex}
  \input{selec_and_cats/selec_and_cats.tex}
